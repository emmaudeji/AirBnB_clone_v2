#!/usr/bin/env bash
# Script to set up the web servers for the deployment of web_static
...
#--creating the directrry
sudo mkdir -p /data/web_static/releases/test/data/web_static/shared
echo -e "\e[1;32m directories created"
echo

#--adding test string
echo "<h1>Welcome to www.gogrene.tech</h1> <br> <h3>The tech guru</h3><br><h3>learning at alx/Holberton school</h3>" > /data/web_static/releases/test/index.html
